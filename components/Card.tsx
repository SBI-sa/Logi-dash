...
const styles = StyleSheet.create({
  card: {
    ...
    ...(Platform.OS === 'web' ? {
      ...
      boxShadow: '0 22px 40px rgba(0,16,25,0.3), inset 0 1px 0 rgba(255,255,255,0.7), inset 0 -1px 0 rgba(0,0,0,0.10)',
    } : {}),
  },
  glassOverlay: {
  ...
  modalContent: {
    ...
    ...(Platform.OS === 'web' ? {
      backdropFilter: 'blur(60px) saturate(260%) contrast(1.1)',
      WebkitBackdropFilter: 'blur(60px) saturate(260%) contrast(1.1)',
      boxShadow: '0 22px 42px rgba(0,16,25,0.32), inset 0 1px 0 rgba(255,255,255,0.7), inset 0 -1px 0 rgba(0,0,0,0.10)',
    } : {}),
  },
  modalGlassOverlay: {
    position: 'absolute' as const,
